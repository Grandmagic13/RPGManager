...
public enum Fields {
	NAME(String.class), AGE(Integer.class), XP(Integer.class), GENDER(Gender.class), BACKGROUND(Background.class), BASECLASS(BaseClasses.class),
	SPECIALIZATIONCLASSES(SpecializationClassesSet.class), LEVEL(Integer.class), ARMOR_RATING(Integer.class), HEALTH_POINTS(Integer.class),
	MANA_POINTS(Integer.class), APPEARANCE(String.class), DISTINGUISHING_FEATURES(String.class), OFTEN_USED_EQUIPMENT(String.class),
	GOALS_AND_TIES(String.class), EQUIPMENT(String.class), MONEY(Money.class), GOLD_COIN(Integer.class, MONEY), SILVER_COIN(Integer.class, MONEY),
	COPPER_COIN(Integer.class, MONEY), LANGUAGES(LanguagesSet.class), STRENGTH(CharacterAttribute.class), COMMUNICATION(CharacterAttribute.class),
	...
	ARMOR_TYPE(Armors.class), STRAIN(Integer.class), WEAPON_GROUPS(WeaponGroupsSet.class), FOCUSES(FocusesSet.class),
	DEFENSE(Integer.class, DEXTERITY), SPEED(Integer.class, DEXTERITY),;
