...
public class GetDefaultLanguagesForEachBackgroundUnitTests {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				{ Background.ELF_APOSTATE, new LanguagesSet(Languages.TRADE_TONGUE) },
				{ Background.ELF_CIRCLE_MAGE, new LanguagesSet(Languages.ANCIENT_TEVENE, Languages.TRADE_TONGUE) },
				...
				{ Background.HUMAN_APOSTATE, new LanguagesSet(Languages.TRADE_TONGUE) },
				{ Background.HUMAN_CIRCLE_MAGE, new LanguagesSet(Languages.ANCIENT_TEVENE, Languages.TRADE_TONGUE) },
				...
				{ Background.SEHERON_CONVERT, new LanguagesSet(Languages.QUNLAT, Languages.TEVENE, Languages.TRADE_TONGUE) },
