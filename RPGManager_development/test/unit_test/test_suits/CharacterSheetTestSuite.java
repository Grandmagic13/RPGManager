...
@RunWith(Suite.class)
@Suite.SuiteClasses({ GetDefaultValuesUnitTest.class, CharacterSheetUnitTests.class, FieldsUnitTests.class, BaseClassUnitTests.class,
		...
		MoneyUnitTests.class, LanguagesUnitTests.class })
