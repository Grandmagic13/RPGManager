...
public enum Languages {
	...
	public final static LanguagesSet DWARVEN_TRADE = new LanguagesSet(Languages.DWARVEN_LANGUAGE,
			Languages.TRADE_TONGUE);
	...
	public final static LanguagesSet ANCIENT_TEVENE_TRADE = new LanguagesSet(Languages.ANCIENT_TEVENE,
			Languages.TRADE_TONGUE);
	public final static LanguagesSet QUNLAT_TEVENE_TRADE = new LanguagesSet(Languages.QUNLAT, Languages.TEVENE,
			Languages.TRADE_TONGUE);
